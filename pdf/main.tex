...
\begin{itemize}
    \item \textbf{Control del tráfico:} Se puede implementar un programa para que detecte y cuente la cantidad y tipo de vehículos de una intersección para variar dinámicamente el estado de los semáforos.
...
En la figura \ref{fig:context-rcnn} se puede ver el modelo completo. Esta propuesta alcanza un \textbf{42.6\%} de mAP en el dataset CityCam\footnote{El dataset es accesible por \url{https://web.tecnico.ulisboa.pt/~ist12390/public_html/citycam/}}.
...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/st_cnn_1.png}
...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/st_cnn_2.png}
...
\begin{itemize}
    \item\textbf{OCR Dataset\footnote{El dataset es accesible por: \url{https://www.kaggle.com/datasets/trainingdatapro/license-plates-1-209-438-ocr-plates}}:} Contiene 3.8M+ de imágenes de matrículas etiquetadas.
    \item \textbf{License Plate Digits Classification Dataset\footnote{el dataset es accesible por: \url{https://www.kaggle.com/datasets/aladdinss/license-plate-digits-classification-dataset}}:} Está especializado en el reconocimiento de los dígitos de las matrículas.
...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/shine-example.png}
...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/vlms.png}
...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/locnet.png}
...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/lprnet-backbone.png}
...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/lprnet-basicblock.png}
...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/ocr-arc.png}
...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/lprmnist.png}
